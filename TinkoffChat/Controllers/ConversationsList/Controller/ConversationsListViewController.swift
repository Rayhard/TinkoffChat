...
class ConversationsListViewController: UIViewController {
    ...
    var conversationsListExample: [ConversationCellModel] = [
        ...
        ConversationCellModel(name: "Dmitry", message: "asdasdasd", date: Calendar.current.date(byAdding: .day, value: -5, to: Date()) ?? Date(), isOnline: true, hasUnreadMessages: false),
        ConversationCellModel(name: "Ilya", message: "asdasdasd", date: Date(), isOnline: false, hasUnreadMessages: false),
